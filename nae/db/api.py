...
def update_image(id, **values):
    return model_query(models.Image, id=id).update(values)
...
def get_containers(project_id=None, user_id=None):
    ...
    if project_id is None:
        return model_query(models.Container, user_id=user_id).all()
    if user_id is None:
        return model_query(models.Container, project_id=project_id).all()
...
def get_containers_by_host(host_id):
    if not host_id:
        return []
    return model_query(models.Container, host_id=host_id).all()


def get_container(id):
    return model_query(models.Container, id=id).first()


def delete_container(id):
    return model_query(models.Container, id=id).delete()
...
def get_users(project_id):
    ...
    return model_query(models.User, project_id=project_id).all()


def get_user(name):
    return model_query(models.User, name=name).first()
...
def get_repos(project_id):
    ...
    return model_query(models.Repos, project_id=project_id).all()
...
def get_network(id):
    return model_query(models.Network, id=id).first()
...
def get_host(host_id):
    return model_query(models.Host, id=host_id).first()
...
def get_base_image(image_id):
    return model_query(models.BaseImage, id=image_id).first()
